---
title: "Remove subgroup Arts & Hum and adjust categories without observations"
author: "Mingyang Cai"
date: ""
output: 
   html_document:
...
```
The CFI of the configural invariance model is 0.85. So I think the configural invariance model does not fit well. Both p-values for model comparison tests are significant. Thus, we may conclude that weak invariance and weak invariance are not supported in this dataset.
