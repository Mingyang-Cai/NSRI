...
We use the two factors model with 5 modifications which is replaced `NA` by `1` and remove items with over 20% NA answers. All 7-likert QRP and RRP items are treated as continuous variables in the invariance test. 
...
#strong invariance
Model.2.3 <- cfa(Model.2.modi, data = dat, group = "Field", group.equal = c("intercepts", "loadings"))
