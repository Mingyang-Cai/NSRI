...
We use the two factors model which is replaced `NA` by `1` and remove items with over 20% NA answers. All 7-likert QRP and RRP items are treated as continuous variables in the invariance test. 
