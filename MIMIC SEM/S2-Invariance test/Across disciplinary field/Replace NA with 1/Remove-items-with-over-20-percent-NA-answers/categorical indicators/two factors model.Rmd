...
```
The CFI of the configural invariance model is 0.91. Both p-values for model comparison tests are significant. Thus, we may conclude that weak invariance and strong invariance are not supported in this dataset.
...
```
The CFI of the weak invariance model is 0.90.