...
We use the three factors model with 5 modifications which is replaced `NA` by `1` and kept items with over 20% NA answers. All 7-likert QRP and RRP items are treated as continuous variables in the invariance test. 
