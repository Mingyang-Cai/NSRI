---
title: "Part 5-How many factors-16"
author: "Mingyang Cai"
date: ""
output: 
   html_document:
...
Replace 7 for the 0 scores (Not Applicable) in the raw RRP/QRP variables and remove 3 RRPs (`RCorrectPub`, `RPreReg` and `ROpenCode`) and 1 QRP (`QNoReSubmit`) whose percentages of `NA` answers exceed 20%. 
